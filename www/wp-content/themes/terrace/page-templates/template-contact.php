...
<div class="contact-us-holder">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
				<?php echo do_shortcode('[contact-form-7 id="42" title="Contact Us Page Form"]'); ?>
            </div>
            <div class="col-lg-6">
            ...
            <div class="entry-content">
                ...
                <div class="col-lg-10">
                    <div class="img-widescreen">
                        <img src="<?php echo get_template_directory_uri();?>/img/contact-us.jpg" alt="Terrace Contact Us">
                    </div>
                </div>
                </div>
            </div>
